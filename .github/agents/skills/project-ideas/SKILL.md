...
name: project-ideas
description: >
  Brainstorm and prioritize improvement ideas for the project.
...
Produces a prioritized list of concrete improvement ideas for the project, grounded in the actual codebase state.

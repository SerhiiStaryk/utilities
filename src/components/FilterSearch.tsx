import { MenuItem, FormControl, InputLabel, Select as MuiSelect, SxProps } from "@mui/material";
...
export const FilterSearch = ({
  ...
  return (
    <FormControl size="small" sx={formControlStyle}>
      ...
      <MuiSelect value={value} label={t(`${label}`)} onChange={(e) => handleChange(e.target.value)}>
